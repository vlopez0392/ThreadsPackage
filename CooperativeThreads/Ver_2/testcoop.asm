...
;--------------------------------------------------------
	...
	.globl __mcs51_genXRAMCLEAR
	.globl __mcs51_genRAMCLEAR
;	testcoop.c:12: __bit isBufferFull = 0;                 //Bit-addresable register 0x20
;	assignBit
	clr	_isBufferFull
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
;	testcoop.c:15: void producer(void){
;	-----------------------------------------
;	 function producer
;	-----------------------------------------
_producer:
	...
	ar1 = 0x01
	ar0 = 0x00
;	testcoop.c:16: item = (char)0x41;
	mov	_item,#0x41
;	testcoop.c:17: while(1){ 
00107$:
;	testcoop.c:18: if(item > 0x5A){
	mov	a,_item
	add	a,#0xff - 0x5a
	jnc	00103$
;	testcoop.c:19: item = 0x41;
	mov	_item,#0x41
;	testcoop.c:21: while(isBufferFull){ //Poll-Buffer
00103$:
	jnb	_isBufferFull,00105$
;	testcoop.c:22: ThreadYield();
	lcall	_ThreadYield
	sjmp	00103$
00105$:
