...
;Allocation info for local variables in function 'producer'
;------------------------------------------------------------
;	testcoop.c:9: void producer(void){
;	-----------------------------------------
;	 function producer
;	-----------------------------------------
_producer:
...
;------------------------------------------------------------
;	testcoop.c:25: void consumer(void){
;	-----------------------------------------
;	 function consumer
;	-----------------------------------------
_consumer:
;	testcoop.c:27: TMOD = 0x20; 
	mov	_TMOD,#0x20
;	testcoop.c:28: TH1 = -6; 
	mov	_TH1,#0xfa
;	testcoop.c:29: SCON = 0x50; 
	mov	_SCON,#0x50
;	testcoop.c:30: TR1 = 1;
;	assignBit
	setb	_TR1
...
;	assignBit
	clr	_TI
;	testcoop.c:35: while(!isBufferFull){ 
00101$:
	jb	_isBufferFull,00103$
;	testcoop.c:36: ThreadYield();
	lcall	_ThreadYield
	sjmp	00101$
00103$:
;	testcoop.c:38: SBUF = BUFFER;    //Write to SBUF
	mov	_SBUF,_BUFFER
;	testcoop.c:39: isBufferFull = 0; //Buffer empty, data consumed  
;	assignBit
	clr	_isBufferFull
;	testcoop.c:42: while(!TI){
00104$:
	jb	_TI,00106$
;	testcoop.c:43: ThreadYield();
	...
	sjmp	00104$
00106$:
;	testcoop.c:45: TI = 0; //Clear TI flag
;	assignBit
	clr	_TI
;	testcoop.c:47: }
	sjmp	00101$
...
;------------------------------------------------------------
;	testcoop.c:49: void main(void){ 
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	testcoop.c:50: ThreadCreate(producer);  //Create Thread for producer;
	mov	dptr,#_producer
	lcall	_ThreadCreate
;	testcoop.c:51: consumer();              //Call consumer;
;	testcoop.c:52: }
	ljmp	_consumer
;------------------------------------------------------------
;Allocation info for local variables in function '_sdcc_gsinit_startup'
;------------------------------------------------------------
;	testcoop.c:55: void _sdcc_gsinit_startup(void) {
;	-----------------------------------------
;	 function _sdcc_gsinit_startup
;	-----------------------------------------
__sdcc_gsinit_startup:
;	testcoop.c:58: __endasm;
	ljmp	_Bootstrap
;	testcoop.c:59: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	testcoop.c:60: void _mcs51_genRAMCLEAR(void) { }
;	-----------------------------------------
...
;------------------------------------------------------------
;	testcoop.c:61: void _mcs51_genXINIT(void) { }
;	-----------------------------------------
...
;------------------------------------------------------------
;	testcoop.c:62: void _mcs51_genXRAMCLEAR(void) { }
;	-----------------------------------------
